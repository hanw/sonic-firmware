...
set_false_path -to {*|top_serdes:serdes|*|tx_digitalreset_reg0c[0]}
set_false_path -to {*|top_serdes:serdes|*|rx_digitalreset_reg0c[0]}
#
...
#
set_multicycle_path -start -setup -from [get_keepers {*|top_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_ctl_wr}] $tl_cfg_ctl_wr_setup
set_multicycle_path -end -setup -from [get_keepers {*|top_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_ctl[*]}] [expr $tl_cfg_ctl_wr_setup + 2]
set_multicycle_path -end -hold -from [get_keepers {*|top_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_ctl[*]}] 3
#
set_multicycle_path -start -setup -from [get_keepers {*|top_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_sts_wr}] $tl_cfg_sts_wr_setup
set_multicycle_path -end -setup -from [get_keepers {*|top_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_sts[*]}] [expr $tl_cfg_sts_wr_setup + 2]
set_multicycle_path -end -hold -from [get_keepers {*|top_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|tl_cfg_sts[*]}] 3
