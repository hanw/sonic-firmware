...
module crcchk (
	...
	crcchk_altcrc	crcchk_altcrc_inst(
		.clk(clk),
		.data(data),
		.datavalid(datavalid),
		.empty(empty),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="crcchk_altcrc" >
...
// Retrieval info:      <PRIVATE name = "p_lsb" value="0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="crcchk_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "filename" value="crcchk.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
