...
JedecChain;
	...
	P ActionCode(Cfg)
		Device PartName(EP4S100G2F40) Path("/home/hwang/sonic/projects/sonic_fpga_bugfix/pcie-2p-port1/src/top_examples/sonic_chaining_dma/") File("top_example_chaining_top.sof") MfrSpec(OpMask(1));
