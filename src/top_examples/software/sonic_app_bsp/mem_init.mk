...
# Memory: nios_base_onchip_ram
MEM_0 := nios_base_onchip_ram
$(MEM_0)_NAME := nios_base_onchip_ram
...
$(MEM_0)_HIERARCHICAL_PATH := nios_base.onchip_ram
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: nios_base_onchip_ram
nios_base_onchip_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
