...
/*
  ...
  Each input/output lane is associated with 4 32-bit registers.
  ------------------------------------------------------------
    byte address    |           definition
  ------------------------------------------------------------
   0x0000_0000      | user_datain register base address
   0x0000_0004      | user_dataout register base address
   0x0000_0008      | irq_mask register base address
   0x0000_000C      | edga_capture register base address
  ------------------------------------------------------------
...
module avalon_mm_slave (
	...
	// slave interface
	// slave address is dword-aligned.
