...
alias com {
   ...
   vlog -sv "$QSYS_SIMDIR/submodules/sonic_v1_15_rsp_xbar_mux_002.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"
   ...
   vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/sonic_v1_15_cmd_xbar_mux_002.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/sonic_v1_15_cmd_xbar_mux.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/sonic_v1_15_cmd_xbar_demux_002.sv"
   ...
   vlog -sv "$QSYS_SIMDIR/submodules/sonic_v1_15_addr_router_002.sv"
   ...
   vlog "$QSYS_SIMDIR/submodules/custom_master.v"
   vlog "$QSYS_SIMDIR/submodules/burst_write_master.v"
   vlog "$QSYS_SIMDIR/submodules/burst_read_master.v"
