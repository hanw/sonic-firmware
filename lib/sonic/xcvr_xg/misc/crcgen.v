...
module crcgen (
	...
	crcgen_altcrc	crcgen_altcrc_inst(
		.clk(clk),
		.data(data),
		.datavalid(datavalid),
		.empty(empty),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="crcgen_altcrc" >
...
// Retrieval info:      <PRIVATE name = "filename" value="crcgen_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "filename" value="crcgen.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
