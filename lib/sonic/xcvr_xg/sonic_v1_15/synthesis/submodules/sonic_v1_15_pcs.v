...
// This file was auto-generated from altera_ref_pcs_design_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using SOPC Builder version 11.0 157 at 2011.08.01.12:24:03

`timescale 1 ps / 1 ps
module sonic_v1_15_pcs #(
		...
		input  wire        rx_is_lockedtodata_export,       //         rx_is_lockedtodata.export
		input  wire        rx_is_lockedtoref_export,        //          rx_is_lockedtoref.export
		input  wire [39:0] pma_parallel_rx_data_data,       //       pma_parallel_rx_data.data
		output wire [39:0] pma_parallel_tx_data_data,       //       pma_parallel_tx_data.data
		input  wire        rx_pma_clk_clk,                  //                 rx_pma_clk.clk
		input  wire        tx_pma_clk_clk,                  //                 tx_pma_clk.clk
		input  wire        tx_pma_ready_export,             //               tx_pma_ready.export
		input  wire        rx_pma_ready_export,             //               rx_pma_ready.export
		input  wire        tx_digital_rst_export,           //             tx_digital_rst.export
		input  wire        rx_digital_rst_export,           //             rx_digital_rst.export
	...
	wire  [71:0] altera_10gbaser_xgmii_rx_dc_data;                                                                              // altera_10gbaser:xgmii_rx_dc -> eth_loopback_composed:lb_rx_sink_data_data
	wire  [71:0] eth_loopback_composed_lb_tx_src_data_data;                                                                     // eth_loopback_composed:lb_tx_src_data_data -> altera_10gbaser:xgmii_tx_dc
	...
	altera_xcvr_10gbaser_pcs_only #(
		...
		.phy_mgmt_read        (altera_10gbaser_phy_mgmt_translator_avalon_anti_slave_0_read),        //             phy_mgmt.read
		.phy_mgmt_write       (altera_10gbaser_phy_mgmt_translator_avalon_anti_slave_0_write),       //                     .write
		.phy_mgmt_address     (altera_10gbaser_phy_mgmt_translator_avalon_anti_slave_0_address),     //                     .address
		...
		.rx_recovered_clk     (),                                                                    //     rx_recovered_clk.clk
		.tx_ready             (tx_ready_export),                                                     //             tx_ready.export
		.rx_ready             (rx_ready_export),                                                     //             rx_ready.export
		.rx_data_ready        (),                                                                    //        rx_data_ready.export
		.rx_block_lock        (),                                                                    //        rx_block_lock.export
		.rx_hi_ber            (),                                                                    //            rx_hi_ber.export
		.xgmii_tx_dc          (eth_loopback_composed_lb_tx_src_data_data),                           //          xgmii_tx_dc.data
		.xgmii_rx_dc          (altera_10gbaser_xgmii_rx_dc_data),                                    //          xgmii_rx_dc.data
		...
		.pma_parallel_rx_data (pma_parallel_rx_data_data),                                           // pma_parallel_rx_data.data
		.pma_parallel_tx_data (pma_parallel_tx_data_data),                                           // pma_parallel_tx_data.data
		.rx_pma_clk           (rx_pma_clk_clk),                                                      //           rx_pma_clk.clk
		.tx_pma_clk           (tx_pma_clk_clk),                                                      //           tx_pma_clk.clk
		.tx_pma_ready         (tx_pma_ready_export),                                                 //         tx_pma_ready.export
		.rx_pma_ready         (rx_pma_ready_export),                                                 //         rx_pma_ready.export
		.tx_digital_rst       (tx_digital_rst_export),                                               //       tx_digital_rst.export
		.rx_digital_rst       (rx_digital_rst_export),                                               //       rx_digital_rst.export
		.tx_rst_digital       (1'b0),                                                                    //       tx_rst_digital.export
		.rx_rst_digital       (1'b0),                                                                    //       rx_rst_digital.export
		.gxb_pdn              (1'b0),                                                                    //              gxb_pdn.export
		.pll_locked           (),                                                                    //           pll_locked.export
		.pll_pdn              (1'b0),                                                                    //              pll_pdn.export
		.cal_blk_pdn          (1'b0),                                                                    //          cal_blk_pdn.export
		.cal_blk_clk          (1'b0),                                                                    //          cal_blk_clk.export
		.reconfig_from_xcvr   (4'b0000),                                                                    //   reconfig_from_xcvr.export
		.reconfig_to_xcvr     ()                                                                     //     reconfig_to_xcvr.export
	);

	sonic_v1_15_pcs_eth_10g_mac eth_10g_mac (
	...
	sonic_v1_15_pcs_eth_loopback_composed eth_loopback_composed (
		.tx_clk_clk           (tx_clk_clk),                                                           //          tx_clk.clk
		.tx_reset_reset_n     (tx_reset_reset_n),                                                     //        tx_reset.reset_n
		.rx_clk_clk           (xgmii_rx_clk_clk),                                                     //          rx_clk.clk
		.rx_reset_reset_n     (ref_reset_reset_n),                                                    //        rx_reset.reset_n
		...
		.lb_rx_sink_data_data (altera_10gbaser_xgmii_rx_dc_data),                                     // lb_rx_sink_data.data
	...
	sonic_v1_15_pcs_pa_pg_before_timing_adapter pa_pg_before_timing_adapter (
		.clk       (xgmii_rx_clk_clk),                                         //   clk.clk
	...
	sonic_v1_15_pcs_pa_pg_after_timing_adapter pa_pg_after_timing_adapter (
		.clk      (tx_clk_clk),                              //   clk.clk
	...
	sonic_v1_15_pcs_addr_router addr_router (
	...
	sonic_v1_15_pcs_id_router id_router (
	...
	sonic_v1_15_pcs_id_router id_router_001 (
	...
	sonic_v1_15_pcs_id_router id_router_002 (
	...
	sonic_v1_15_pcs_id_router id_router_003 (
	...
	sonic_v1_15_pcs_id_router id_router_004 (
	...
	sonic_v1_15_pcs_id_router id_router_005 (
	...
	sonic_v1_15_pcs_cmd_xbar_demux cmd_xbar_demux (
		.clk                (mm_clk_clk),                        //        clk.clk
		.reset              (rst_controller_reset_out_reset),    //  clk_reset.reset
	...
	sonic_v1_15_pcs_rsp_xbar_demux rsp_xbar_demux (
		.clk                (mm_clk_clk),                        //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	sonic_v1_15_pcs_rsp_xbar_demux rsp_xbar_demux_001 (
		.clk                (mm_clk_clk),                            //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	sonic_v1_15_pcs_rsp_xbar_demux rsp_xbar_demux_002 (
		.clk                (mm_clk_clk),                            //       clk.clk
		.reset              (rst_controller_003_reset_out_reset),    // clk_reset.reset
	...
	sonic_v1_15_pcs_rsp_xbar_demux rsp_xbar_demux_003 (
		.clk                (tx_clk_clk),                            //       clk.clk
		.reset              (rst_controller_001_reset_out_reset),    // clk_reset.reset
	...
	sonic_v1_15_pcs_rsp_xbar_demux rsp_xbar_demux_004 (
		.clk                (xgmii_rx_clk_clk),                      //       clk.clk
		.reset              (rst_controller_002_reset_out_reset),    // clk_reset.reset
	...
	sonic_v1_15_pcs_rsp_xbar_demux rsp_xbar_demux_005 (
		.clk                (mm_clk_clk),                            //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	sonic_v1_15_pcs_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (mm_clk_clk),                            //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
