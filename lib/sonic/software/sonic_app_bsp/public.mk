...
# CPU Name 
# setting CPU_NAME is nios_base_cpu
CPU_NAME = nios_base_cpu
...
# Design Name 
# setting SOPC_NAME is sonic_v1_15
SOPC_NAME := sonic_v1_15
...
# The SOPC System ID 
# setting SOPC_SYSID is 953745243
SOPC_SYSID_FLAG += --id=953745243
ELF_PATCH_FLAG  += --id 953745243

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x42038
SOPC_SYSID_FLAG += --sidp=0x42038
ELF_PATCH_FLAG  += --sidp 0x42038

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1314327916
SOPC_SYSID_FLAG += --timestamp=1314327916
ELF_PATCH_FLAG  += --timestamp 1314327916
...
# setting hal.stderr is nios_base_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev nios_base_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is nios_base_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev nios_base_jtag_uart
...
# setting hal.stdout is nios_base_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev nios_base_jtag_uart
