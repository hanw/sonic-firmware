...
if ![info exist TOP_LEVEL_NAME] { 
   set TOP_LEVEL_NAME "sonic_rp_ep_sim_tb"
...
alias com {
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/sonic_fast_sim_top.sv"
   vlog "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/altera_reset_controller.v"
   vlog "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/altera_reset_synchronizer.v"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/avalon_utilities_pkg.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/verbosity_pkg.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/altera_avalon_st_source_bfm.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/avalon_utilities_pkg.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/verbosity_pkg.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/altera_avalon_st_sink_bfm.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/verbosity_pkg.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/altera_avalon_reset_source.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/verbosity_pkg.sv"
   vlog -sv "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/altera_avalon_clock_source.sv"
   vlog "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/submodules/sonic_rp_ep_sim_tb_sonic_rp_ep_sim_inst.v"
   vlog "$QSYS_SIMDIR/sonic_rp_ep_sim_tb/simulation/sonic_rp_ep_sim_tb.v"
}
