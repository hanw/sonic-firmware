...
if ![info exist TOP_LEVEL_NAME] { 
   set TOP_LEVEL_NAME "sonic_monitor"
...
alias com {
   ...
   vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_monitor_assertion.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_monitor_coverage.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_monitor_transactions.sv"
   vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_monitor.sv"
   vlog "$QSYS_SIMDIR/sonic_monitor.v"
}
