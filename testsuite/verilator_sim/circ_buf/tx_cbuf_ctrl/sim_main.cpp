...
#include "Vsonic_tx_ctl_66.h"		// From Verilating "sonic_blocksync_xg.sv"
...
Vsonic_tx_ctl_66 *top;	// Instantiation of module
...
int main(int argc, char **argv, char **env) {
    ...
    top = new Vsonic_tx_ctl_66;		// Create instance of module
    ...
    tfp->open ("Vsonic_tx_ctl_66.vcd");	// Open the dump file
#endif
...
#endif
*/
        if (main_time >500 && main_time % 2 == 0)
