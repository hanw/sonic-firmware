...
module sonic_v1_15_jtag_master #(
	...
	sonic_v1_15_jtag_master_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	sonic_v1_15_jtag_master_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~clk_reset_reset),                     // reset.reset_n
	...
	sonic_v1_15_jtag_master_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~clk_reset_reset),                   // reset.reset_n
