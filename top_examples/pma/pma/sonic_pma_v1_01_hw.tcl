...
# | null 2011.07.13.23:13:49
# | 
# | 
# | /home/hwang/sonic/projects/sonic_v1_11/src/pma/sonic_pma_v1_01.v
# | 
...
add_interface_port tx_serial_data tx_serial_data export Output 1
# | 
# +-----------------------------------
...
add_interface_port rx_serial_data rx_serial_data export Input 1
# | 
# +-----------------------------------
...
add_interface_port rx_is_lockedtoref rx_is_lockedtoref export Output 1
# | 
# +-----------------------------------
...
add_interface_port rx_is_lockedtodata rx_is_lockedtodata export Output 1
# | 
# +-----------------------------------
